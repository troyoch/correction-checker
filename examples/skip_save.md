...
| current_conversation | pass | fail | fail | pass | storage |
| fresh_conversation | pass | fail | fail | fail | storage |
| after_restart | pass | fail | fail | fail | storage |
| after_summary_update | pass | fail | fail | fail | storage |
